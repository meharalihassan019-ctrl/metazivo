                ...
                <div key={item.id} className="bg-white border border-slate-200/80 rounded-[32px] overflow-hidden shadow-sm flex flex-col justify-between">
                  ...
                  <div className="p-5 space-y-3">
                    <div className="flex justify-between items-center text-xs">
                      ...
                      <span className="text-slate-500">{(item as any).category}</span>
                    </div>
                    <h3 className="text-base font-bold text-slate-900">{item.title}</h3>
                    <p className="text-xs text-slate-600 leading-relaxed font-light">{item.description}</p>
                    
                    {(item as any).playStoreUrl && (
                      <div className="pt-2 flex flex-wrap gap-2">
                        <a
                          href={(item as any).playStoreUrl}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex items-center gap-1.5 px-4 py-2 bg-slate-950 hover:bg-[#FF5722] text-white rounded-xl text-[11px] font-bold transition-all shadow-sm cursor-pointer active:scale-95"
                        >
