        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 sm:gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-3.5">
              ...
              <li><button onClick={() => handleNavClick("free-tools")} className="text-slate-400 hover:text-[#FF5722] text-sm transition-colors text-left flex items-center gap-2 group"><span className="opacity-0 group-hover:opacity-100 transition-opacity text-[#FF5722] text-xs">→</span> Meta Tag Generator</button></li>
              <li><button onClick={() => handleNavClick("tools/website-speed-test")} className="text-slate-400 hover:text-[#FF5722] text-sm transition-colors text-left flex items-center gap-2 group"><span className="opacity-0 group-hover:opacity-100 transition-opacity text-[#FF5722] text-xs">→</span> Website Speed Test</button></li>
